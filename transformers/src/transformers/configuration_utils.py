...
class PretrainedConfig(PushToHubMixin):
    ...
    def __init__(self, **kwargs):
        ...
        self.apply_lora = kwargs.pop("apply_lora", False)
        self.lora_r = kwargs.pop("lora_r", 8)
        self.lora_alpha = kwargs.pop("lora_alpha", 16)

        self.threshold_ratio_inhi = kwargs.pop("threshold_ratio_inhi", 0.0)
        self.gi_key_side = kwargs.pop("gi_key_side", False)
        self.gi_query_side = kwargs.pop("gi_query_side", False)
        self.gi_value_side = kwargs.pop("gi_value_side", False)
        self.quant_m = kwargs.pop("quant_m", 'original')
        self.weight_i_width = kwargs.pop("weight_i_width", 0)
        self.weight_f_width = kwargs.pop("weight_f_width", 0)
        self.selected_layer = kwargs.pop("selected_layer", None)
